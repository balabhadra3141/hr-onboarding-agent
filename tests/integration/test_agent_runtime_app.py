...
# Mock google.auth.default before importing App to prevent GoogleAuthError on systems without GCP credentials
import google.auth
from google.auth import credentials
google.auth.default = lambda *args, **kwargs: (credentials.AnonymousCredentials(), "mock-project")

# Mock initializer global config private fields to prevent GoogleAuthError during imports/initialization
